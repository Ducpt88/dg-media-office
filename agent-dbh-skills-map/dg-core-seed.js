(function seedDgCoreIntoSkillsMap() {
  ...
  const orgNodes = [
    {
      ...
      deadline: today,
      locked: true,
      notes: "Founder Operating AI. Dieu phoi task, agent, workflow, report va memory.",
      members: [
        { name: "D-Gin", emoji: "♛", role: "Founder Operating AI" },
        { name: "Team Leader", emoji: "🧭", role: "Task dispatcher" }
      ]
    },
    {
      id: "dg-ops-kpi",
      ...
      members: [
        ...
        { name: "Team Leader", emoji: "🧭", role: "Follow-up" }
      ]
    },
    {
      id: "dg-brand-video",
    ...
    },
    {
      ...
      progress: 40,
      deadline: today,
      notes: "Editor tong: 2 mang video (Thuong hieu + Triet ly). Publish package goi gon 4 nen tang: YouTube, Facebook, TikTok, Website. QA + Founder duyet roi moi dang.",
      members: [
    ...
    },
    {
      ...
      progress: 30,
      deadline: today,
      notes: "Noi nao bi ket se day ve Waiting Review/Rework: thieu asset, chua QA, chua Founder OK, loi credential/API.",
      members: [
        { name: "QA Gate", emoji: "🛡", role: "Pass/fail" },
        { name: "Founder", emoji: "👑", role: "Final approval" }
      ]
    }
  ];
  ...
  const staffKpiTasks = [
    ...
    { id: "dg-kpi-003", deadline: "09:30", assignee: "Team Leader", owner: "Team Leader", text: "[Team Leader] Go viec cho tung nhan su trong van phong Skills Map", status: "doing", target: 20, targetUnit: "nguoi/agent" },
    ...
    { id: "dg-kpi-006", deadline: "11:30", assignee: "Khoa (Dev)", owner: "Khoa (Dev)", text: "[Dev] Review loi code bridge, log loi credential/API, cap nhat noi dang ket", status: "doing", target: 1, targetUnit: "report" },
    ...
    { id: "dg-kpi-008", deadline: "14:30", assignee: "Quan (Intern)", owner: "Quan (Intern)", text: "[Intern] Gom asset/hinh/voice cho video va bai website, danh dau thieu asset", status: "pending", target: 10, targetUnit: "asset" },
    { id: "dg-kpi-009", deadline: "15:00", assignee: "Vy (Ke toan)", owner: "Vy (Ke toan)", text: "[Finance] Check chi phi tool/API/ads lien quan workflow hom nay", status: "pending", target: 1, targetUnit: "bang chi phi" },
    { id: "dg-kpi-010", deadline: "15:30", assignee: "Thuy (YT Design)", owner: "Thuy (YT Design)", text: "[Design] Thiet ke/kiem tra thumbnail, cover, hinh minh hoa cho bai va video", status: "pending", target: 6, targetUnit: "asset" },
    { id: "dg-kpi-011", deadline: "16:00", assignee: "Linh (YT Content)", owner: "Linh (YT Content)", text: "[Content] Soat title/meta/SEO va checklist dang bai website", status: "pending", target: 5, targetUnit: "bai" },
    { id: "dg-kpi-012", deadline: "16:30", assignee: "QA Gate", owner: "QA Gate", text: "[QA Gate] Check tat ca viec ket: SEO, asset, render, link, credential, Founder OK", status: "review", target: 6, targetUnit: "gate" },
    ...
    { id: "dg-kpi-014", deadline: "18:00", assignee: "Founder", owner: "Founder", text: "[Founder] Duyet viec P0/P1: noi nao cho phe duyet thi cham pass/fail", status: "pending", target: 1, targetUnit: "approval" },
  ...
  const officeTeams = [
    { name: "Founder / Core", color: "#ffd700", members: ["ceo", "pm_lead"] },
  ...
  const teamDailyOps = {
    members: [
      { id: 1, name: "Founder", role: "Founder Office", icon: "CEO", permission: "Owner", status: "online" },
      ...
      { id: 9, name: "Team Leader", role: "Follow-up / Task Dispatch", icon: "TL", permission: "Manager", status: "online" },
      { id: 10, name: "Khoa (Dev)", role: "Developer / Code Bridge", icon: "DEV", permission: "Editor", status: "busy" },
      { id: 11, name: "Tung (Dev)", role: "Developer", icon: "DEV", permission: "Editor", status: "online" },
      { id: 12, name: "Minh (Dev)", role: "Developer", icon: "DEV", permission: "Editor", status: "online" },
      { id: 13, name: "Cuong (PM)", role: "Project Manager", icon: "PM", permission: "Manager", status: "busy" },
      { id: 14, name: "Hai (PM)", role: "Project Manager", icon: "PM", permission: "Manager", status: "online" },
      { id: 15, name: "Mai (HR)", role: "HR / People Ops", icon: "HR", permission: "Reviewer", status: "online" },
      { id: 16, name: "Quan (Intern)", role: "Intern / Asset Review", icon: "INT", permission: "Worker", status: "online" },
      { id: 17, name: "Thuy (YT Design)", role: "Design / Thumbnail", icon: "DES", permission: "Editor", status: "online" },
      { id: 18, name: "Linh (YT Content)", role: "Content / SEO", icon: "CON", permission: "Editor", status: "online" },
      { id: 19, name: "Vy (Ke toan)", role: "Accounting / Cost Control", icon: "ACC", permission: "Reviewer", status: "away" },
      { id: 20, name: "Tu", role: "Marketing / Video", icon: "MKT", permission: "Editor", status: "online" },
    ...
    tasks: [
      ...
      { id: 9109, title: "Soat buoc ket: asset, QA, Founder OK, API/credential", ownerId: 7, priority: "P0", status: "review", due: "16:30", dept: "QA Gate" },
    ...
    reports: [
      {
        ...
        next: "Theo doi task review va bao Founder cac viec P0."
      }
    ],
    messages: [
